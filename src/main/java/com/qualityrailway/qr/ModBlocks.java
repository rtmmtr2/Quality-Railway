...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> df4d_floor_d = BLOCKS.register("df4d_floor_d",
            () -> new df4d_floor_d(Block.Properties.of().noOcclusion()));
